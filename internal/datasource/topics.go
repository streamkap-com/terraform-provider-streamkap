				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"messages_7d": schema.Int64Attribute{
							Description:         "Deprecated. Always null: the topic details API does not return a 7-day message count.",
							MarkdownDescription: "**Deprecated:** Always null — the topic details API does not return a 7-day message count.",
							Computed:            true,
							DeprecationMessage:  "messages_7d is always null; the topic details API does not return it.",
						},
						"messages_30d": schema.Int64Attribute{
							Description:         "Deprecated. Always null: the topic details API does not return a 30-day message count.",
							MarkdownDescription: "**Deprecated:** Always null — the topic details API does not return a 30-day message count.",
							Computed:            true,
							DeprecationMessage:  "messages_30d is always null; the topic details API does not return it.",
						},
					},
				},
			},
