...
var dbHostname = os.Getenv("SOURCE_POSTGRESQL_HOSTNAME")
var dbPassword = os.Getenv("SOURCE_POSTGRESQL_PASSWORD")
...
`, dbHostname, dbPassword),
          ...
          resource.TestCheckResourceAttr("streamkap_source_postgresql.test", "database_hostname", dbHostname),
          ...
          resource.TestCheckResourceAttr("streamkap_source_postgresql.test", "database_password", dbPassword),
