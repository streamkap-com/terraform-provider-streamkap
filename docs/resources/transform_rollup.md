...
page_title: "streamkap_transform_rollup Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a Rollup transform connector.
  This resource creates and manages a Rollup transform for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/streamkap-provider-for-terraform
---

# streamkap_transform_rollup (Resource)
...
```shell
# Import an existing Rollup transform by its ID
terraform import streamkap_transform_rollup.example <transform-id>
```
