...
page_title: "streamkap_source_supabase Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a Supabase source connector.
  This resource creates and manages a Supabase source for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/streamkap-provider-for-terraform
---

# streamkap_source_supabase (Resource)
...
```shell
# Source Supabase can be imported by specifying the identifier.
terraform import streamkap_source_supabase.example-source-supabase 00000000000000000000000000
```
