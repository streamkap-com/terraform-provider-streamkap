...
subcategory: ""
description: |-
  Manages a Oracle destination connector.
  This resource creates and manages a Oracle destination for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
