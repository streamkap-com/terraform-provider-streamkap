...
page_title: "streamkap_destination_motherduck Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a Motherduck destination connector.
  This resource creates and manages a Motherduck destination for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/streamkap-provider-for-terraform
---

# streamkap_destination_motherduck (Resource)
...
- `motherduck_catalog` (String) The name of the Motherduck database/catalog to use.
- `motherduck_token` (String, Sensitive) Motherduck Token
...
```shell
# Destination Motherduck can be imported by specifying the identifier.
terraform import streamkap_destination_motherduck.example 00000000000000000000000000
```
