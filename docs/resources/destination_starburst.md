...
page_title: "streamkap_destination_starburst Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
...
# streamkap_destination_starburst (Resource)
...
- `aws_access_key_id` (String, Sensitive) The AWS Access Key ID used to connect to Starburst.

**Security:** This value is marked sensitive and will not appear in CLI output or logs.
- `aws_s3_bucket_name` (String) The Bucket to use.
- `aws_secret_access_key` (String, Sensitive) The AWS Secret Access Key used to connect to Starburst.
...
terraform import streamkap_destination_starburst.example 00000000000000000000000000
```
