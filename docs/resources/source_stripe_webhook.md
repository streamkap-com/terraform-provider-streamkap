...
page_title: "streamkap_source_stripe_webhook Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a Stripe source connector.
  This resource creates and manages a Stripe source for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/streamkap-provider-for-terraform
---

# streamkap_source_stripe_webhook (Resource)
...
- `topic_include_list` (String) Stripe resources to capture. Each resource maps to a Kafka topic. Fan-out topics are added automatically when fan-out fields are configured. Defaults to `customer,payment_intent,charge,invoice`.
...
```shell
# Source Stripe webhook can be imported by specifying the identifier.
terraform import streamkap_source_stripe_webhook.example-source-stripe-webhook 00000000000000000000000000
```
