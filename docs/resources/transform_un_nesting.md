...
page_title: "streamkap_transform_un_nesting Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages an Un-Nesting transform connector.
  This resource creates and manages an Un-Nesting transform for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/streamkap-provider-for-terraform
---

# streamkap_transform_un_nesting (Resource)
