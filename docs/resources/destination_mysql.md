...
page_title: "streamkap_destination_mysql Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a MySQL destination connector.
  This resource creates and manages a MySQL destination for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/mysql-source-faq
---

# streamkap_destination_mysql (Resource)
...
```shell
# Destination MySQL can be imported by specifying the identifier.
terraform import streamkap_destination_mysql.example 00000000000000000000000000
```
