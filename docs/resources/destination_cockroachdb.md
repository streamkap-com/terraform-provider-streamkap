...
page_title: "streamkap_destination_cockroachdb Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a CockroachDB destination connector.
  This resource creates and manages a CockroachDB destination for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/streamkap-provider-for-terraform
---

# streamkap_destination_cockroachdb (Resource)
...
- `database_hostname` (String) CockroachDB Hostname
...
terraform import streamkap_destination_cockroachdb.example 00000000000000000000000000
```
