...
page_title: "streamkap_destination_sqlserver Resource - terraform-provider-streamkap"
subcategory: ""
description: |-
  Manages a SQL Server destination connector.
  This resource creates and manages a SQL Server destination for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
  Documentation https://docs.streamkap.com/sql-server-source-faq
---

# streamkap_destination_sqlserver (Resource)
...
- `database_hostname` (String) SQL Server Hostname
...
```shell
# Destination SQL Server can be imported by specifying the identifier.
terraform import streamkap_destination_sqlserver.example 00000000000000000000000000
```
