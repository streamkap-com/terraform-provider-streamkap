...
subcategory: ""
description: |-
  Manages an AlloyDB source connector.
  This resource creates and manages an AlloyDB source for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
