...
subcategory: ""
description: |-
  Manages a Oracle source connector.
  This resource creates and manages a Oracle source for Streamkap data pipelines. Use with streamkap_pipeline to connect sources to destinations.
